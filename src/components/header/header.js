          ...
          <div className="row banner">
            <div className="banner-text">
              <Animated animationIn="fadeInUp" animationOut="fadeOutUp" animationInDuration={1000} animationOutDuration={1500} isVisible={true} animationInDelay={300}>
                <h1 className="responsive-headline">Joshua Shepelsky,<br></br> Software Developer.</h1>
              </Animated>
              <Animated animationIn="fadeIn" animationOut="fadeOut" animationInDuration={1000} animationOutDuration={1800} isVisible={true} animationInDelay={1000}>
                <h3>
                  I'm a motivated <span>software developer</span> with extensive experience in multiple programming languages and technologies. I love <span>fast-paced</span> environments, <span>collaborating</span> in teams and <span>learning</span> new technologies.
